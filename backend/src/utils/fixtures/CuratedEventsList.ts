import { Event } from '../remote-functions'
  ...
  events: [
    {
      ...
      summary:
        "Nato member state Romania said what appeared to be fragments of a Russian drone had been found on its territory. 'Angel Tilvar, the Romanian defence minister, told local news channel Antena 3 CNN that parts of what was most likely a drone were discovered in the eastern Tulcea county.' \nThe area is part of the Danube delta, which forms a natural border between Romania and war-torn Ukraine. \"I confirm that in this area, pieces that may be of a drone were found,\" he said, adding that the pieces didn't ... ",
      date: '2023-09-04',
      imageUrls: [
