  ...
  details: {
    ...
    articles: [
      ...
      },
      {
        ...
        body:
          'Court strikes out firearm charge against suspended CBN governor, Godwin Emefiele\n' +
          '\n' +
      ...
      },
      {
        ...
        body:
          'Through a press release, Mahamat urged the stakeholders and all military, political, and social actors to put an immediate end to the hostilities that, according to local sources, also wounded 146 people.\n' +
          '\n' +
